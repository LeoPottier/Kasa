...
function Rate({ note }) {
    ...
    const activeStarsArray = Array(activeStars).fill(<img src={active} alt="rate active" />);

    // Créer un tableau d'éléments JSX pour les étoiles inactives
    const inactiveStarsArray = Array(5 - activeStars).fill(<img src={inactive} alt="rate inactive" />);
